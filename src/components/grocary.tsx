...
const products = [
    { id: 1, name: 'Organic Apples', price: '₹180/kg', image: 'https://via.placeholder.com/150/92c952', category: 'Fruits & Veggies' },
    { id: 2, name: 'Fresh Milk', price: '₹60/L', image: 'https://ik.imagekit.io/pimx50ija/a724040be383b8998f45c55442e26262.jpg?updatedAt=1755526347692', category: 'Dairy & Bread' },
    { id: 3, name: 'Potato Chips', price: '₹30', image: 'https://via.placeholder.com/150/24f355', category: 'Snacks & Drinks' },
    { id: 4, name: 'Brown Bread', price: '₹45', image: 'https://via.placeholder.com/150/d32776', category: 'Dairy & Bread' },
    { id: 5, name: 'Carrots', price: '₹50/kg', image: 'https://via.placeholder.com/150/f66b97', category: 'Fruits & Veggies' },
    { id: 6, name: 'Orange Juice', price: '₹90/L', image: 'https://via.placeholder.com/150/56a8c2', category: 'Snacks & Drinks' },
];

const Grocery: React.FC = () => {
    const [selectedCategory, setSelectedCategory] = useState<string | null>(null);

    // This variable will now filter products based on the selected category.
